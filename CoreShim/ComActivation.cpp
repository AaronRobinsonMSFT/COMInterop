    ...
    LPVOID   *ppv)
{
    ...
    using GetClassFactoryForType_ptr = HRESULT(*)(void *);
    GetClassFactoryForType_ptr GetClassFactoryForType;
    RETURN_IF_FAILED(inst->CreateDelegate("CoreShim_Activation", "CoreShim.ComActivator", "GetClassFactoryForType", (void**)&GetClassFactoryForType));
    ...
    RETURN_IF_FAILED(GetClassFactoryForType(&comCxt));
    assert(ccw != nullptr);
